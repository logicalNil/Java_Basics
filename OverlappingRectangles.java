...
public class OverlappingRectangles {
    ...
    public static int overlappingRectangles(String[] strArr) {
        int[] rectangle1 = Arrays.stream(strArr[0].split(",")).mapToInt(Integer::parseInt).toArray();
        int[] rectangle2 = Arrays.stream(strArr[1].split(",")).mapToInt(Integer::parseInt).toArray();
